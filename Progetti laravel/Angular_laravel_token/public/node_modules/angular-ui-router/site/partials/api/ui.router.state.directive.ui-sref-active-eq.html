...
<div><h2 id="description">Description</h2>
    ...
    <div class="description">
        <div class="ui-router-state-directive-page ui-router-state-directive-ui-sref-active-eq-page"><p>The same as <a
                href="#/api/ui.router.state.directive:ui-sref-active">ui-sref-active</a> but will only activate
