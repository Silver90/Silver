...
@section('content')
    ...
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="form-group {!! $title or '' !!}">
            {!! Form::text('title', $value = null, ['class' => 'form-control input-lg', 'placeholder' => 'Enter the
            title here']) !!}
        </div>

        <div class="form-group {!! $url or '' !!}">
            {!! Form::text('url', $value = null, ['class' => 'form-control input-lg', 'placeholder' =>
            'http://example.com']) !!}
        </div>

        <div class="form-group {!! $sub or '' !!}">
            {!! Form::text('sub', $value = null, ['class' => 'form-control input-lg', 'placeholder' => 'Name of sub
            here']) !!}
        </div>
