...
<div><h2 id="description">Description</h2>
    ...
    <div class="description">
        <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-page"><p>The ui-view directive
            tells $state where to place your templates.</p>
        </div>
    </div>
    <h2 id="dependencies">Dependencies</h2>
    <ul class="dependencies">
        <li><code ng:non-bindable=""><a href="#/api/ui.router.state.$state">$state</a></code>
        </li>
...
&lt;/ANY&gt;</pre>
        ...
        <table class="variables-matrix table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-page"><p>A view name.
                        The name should be unique amongst the other views in the
            ...
            <tr>
                ...
                <td><a href="" class="label type-hint type-hint-string">string</a></td>
                <td>
                    <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-page"><p>It allows you
                        to set the scroll behavior of the browser window
                        when a view is populated. By default, $anchorScroll is overridden by ui-router&#39;s custom
                        scroll
                        service, <a href="#/api/ui.router.state.$uiViewScroll">ui.router.state.$uiViewScroll</a>. This
                        custom service let&#39;s you
                        scroll ui-view elements into view when they are populated during a state activation.</p>

                        <p><em>Note: To revert back to old <a
                                href="http://docs.angularjs.org/api/ng.$anchorScroll"><code>$anchorScroll</code></a>
            ...
            <tr>
                ...
                <td><a href="" class="label type-hint type-hint-string">string</a></td>
                <td>
                    <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-page"><p>Expression to
                        evaluate whenever the view updates.</p>
                    </div>
                </td>
            </tr>
            </tbody>
    ...
    <div class="member event"><h2 id="events">Events</h2>
        <ul class="events">
            <li><h3 id="events_$viewcontentloaded">$viewContentLoaded</h3>

                <div class="$viewcontentloaded">
                    <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-viewcontentloaded-page">
                        <p><em>
                            Fired once the view is <strong>loaded</strong>, </em>after* the DOM is rendered.</p>
                    </div>
                    <div class="inline"><h4 id="events_$viewcontentloaded_type">Type:</h4>
    ...
    <div class="example">
        <div class="ui-router-state-directive-page ui-router-state-directive-ui-view-page"><p>A view can be unnamed or
            named.
...
$stateProvider.state("home", {
  template: "&lt;h1&gt;HELLO!&lt;/h1&gt;"
            ...
            <p>The above is a convenient shortcut equivalent to specifying your view explicitly with the <a
                    href="#/api/ui.router.state.$stateProvider#views"><code>views</code></a>
