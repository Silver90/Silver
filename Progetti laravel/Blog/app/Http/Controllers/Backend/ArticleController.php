...
class ArticleController extends Controller
{
    ...
    public function getEdit(Request $request, $articleId)
    {
        $categories = Category::all();
    ...
    public function postEdit(Request $request, $articleId)
    {
        ...
        return redirect('backend/articles/edit/' . $articleId)->with('success_message', 'Articolo modificato correttamente');
    }

    public function getDelete($articleId)
    {
        Article::find($articleId)->delete();
        return redirect('backend/articles')->with('success_message', 'Articolo cancellato correttamente.');
    }
}
