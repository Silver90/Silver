...
<head>
    <meta charset="utf-8"/>
    <meta http-equiv="X-UA-Compatibile" contet="IE=edge"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta name="description" content=""/>
    <meta name="author" content=""/>

    <title>@yield('title') - Il Blog di Ignazio</title>
...
<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="{{ url('/') }}"> Il Blog di Ignazio </a>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
               ...
               <span class="fa-stack fa-lg">
                ...
                <p class="copyright text-muted">Copyright Lipari Ignazio - 2015</p>
            </div>
        </div>
    </div>
</footer>
...
<script src="{{ url('asset/frontend/js/clean-blog.min.js') }}"></script>
</body>
</html>
