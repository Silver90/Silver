...
>
    ...
    it(`should
    pass
    if it's a function that passes`, () => {
...
should
pass
if it's a function that returns a promise that resolves`, () => {
...
should
fail
if it's a function that returns a promise that rejects`, () => {
...
>
{
    ...
    scope.options.validators.isHello = () =
>
    deferred.promise;
    scope.options.validators.isHey = () =
>
    deferred2.promise;
