                ...
                return c(l, b), l.include(d), l.include(f), l.include(h), m = function (a) {
                    ...
                    if (null == b && (b = !0), !this.isNotValid(a, !1)) {
                        if (this.renderGMarker(b, function (a) {
                                return function () {
                                    var b, c, d;
                                    return c = a.getProp(a.coordsKey, a.model), d = a.getProp(a.iconKey, a.model), b = a.getProp(a.optionsKey, a.model), a.opts = a.createOptions(c, d, b), a.isLabel(a.gObject) !== a.isLabel(a.opts) && null != a.gObject && (a.gManager.remove(a.gObject), a.gObject = void 0), null != a.gObject && a.gObject.setOptions(a.setLabelOptions(a.opts)), a.gObject || (a.gObject = a.isLabel(a.opts) ? new MarkerWithLabel(a.setLabelOptions(a.opts)) : new google.maps.Marker(a.opts), _.extend(a.gObject, {model: a.model})), a.externalListeners && a.removeEvents(a.externalListeners), a.internalListeners && a.removeEvents(a.internalListeners), a.externalListeners = a.setEvents(a.gObject, a.scope, a.model, ["dragend"]), a.internalListeners = a.setEvents(a.gObject, {
