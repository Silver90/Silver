...
function getApiCheckInstance(config = {}, extraCheckers = {}) {
    ...
    `.
        ...
        function getUrl() {
            let u = output.url;
            if (!u) {
                u = gOut.docsBaseUrl && output.urlSuffix && `${gOut.docsBaseUrl}
                ${output.urlSuffix}
            `.
                trim();
            }
    ...
    function generateMessage() {
        ...
        const newLine = n + n;
        return `You
        passed:${n}${passedArgs}${newLine}`
        +
        `With
        the ${types}:${n}${argTypes}${newLine}`
        +
        `The
        API
        calls
