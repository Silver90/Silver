      ...
      `;
        ...
        function getFormName() {
            ...
            if (bindName) {
                ...
                formName = `${$interpolate.startSymbol()}
            ::
                'formly_' +
                ${bindName}
        ...
        function copyAttributes(attributes) {
            ...
            {
                arrayAttrs.push(`${toKebabCase(nodeName)}
                = "${nodeValue}"`)
                ;
            }
        }
...
function getWatchExpression(watcher, field, index) {
    ...
    if (angular.isFunction(watchExpression)) {
        ...
        watchExpression.displayName = `Formly
        Watch
        Expression
        for field for ${field.key}`
        ;
    }
...
function getWatchListener(watcher, field, index) {
    ...
    if (angular.isFunction(watchListener)) {
        ...
        watchListener.displayName = `Formly
        Watch
        Listener
        for field for ${field.key}`
        ;
